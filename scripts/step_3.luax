--[[
	...
	4) Look at the text file of bone names that you created in step_1.lua. Find the knuckle bones of each finger,
		...
		the knuckleBoneList on line 55
	...
	7) Once your hand_animations.lua file is populated, uncomment the handAnimations parameter on line 72
]]--
...
function on_lazy_poll()
	if not hands.exists() then
		...
		--uevrUtils.fixMeshFOV(hands.getHandComponent(0), "ForegroundPriorityEnabled", 0.0, true, true, true)
